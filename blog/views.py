...
from .forms import PostForm #To display our blogs based on published date
...
from django.shortcuts import redirect #after getting data from forms and on save it will redirect to post_detail view(original page)
def post_new(request):
